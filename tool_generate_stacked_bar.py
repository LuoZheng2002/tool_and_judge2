...
def generate_stacked_bar_chart(model_name: str, output_dir: str, result_dir: str,
    ...
    # Prepare data for plotting - show all 18 combinations grouped by translate mode
    bar_labels = []
    bar_data = []
    bar_positions = []
    pos = 0
    ...
    # Add "Configuration" label below the group names
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Directory to save chart images (default: tool/plots/stacked_bars)"
    )
    parser.add_argument(
        "--result-dir",
        default="tool/result",
