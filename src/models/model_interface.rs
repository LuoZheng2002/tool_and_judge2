...
use crate::{
    ...
    models::{
        deepseek_interface::DeepSeekInterface, function_name_mapper::FunctionNameMapper,
        gpt5_interface::Gpt5Interface, granite4_interface::Granite4Interface,
        llama3_1_interface::Llama3_1Interface, qwen3_interface::Qwen3Interface,
    },
    tool::{
...
pub fn get_model_interface(model: Model) -> Arc<dyn ModelInterface> {
    match model {
        ...
        Model::Local(local_model) => match local_model {
            ...
            | LocalModel::Qwen3_32B
            | LocalModel::Qwen3Next80bA3b => Arc::new(Qwen3Interface),
            LocalModel::Granite4_0HTiny | LocalModel::Granite4_0HSmall => {
                Arc::new(Granite4Interface)
            }
            _ => {
                unimplemented!(
