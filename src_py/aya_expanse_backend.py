...
async def generate_response_async(
    ...
    """
    Generate a single response using vLLM backend asynchronously for Aya Expanse.
    ...
    # Aya Expanse uses standard chat template without special parameters
    ...
    request_id = f"aya_expanse_response_{id(entry)}"
...
async def collect_preference_local_async(
    ...
    """
    Collect preference between two answers using Aya Expanse backend.
    ...
    request_id = f"aya_expanse_preference_{id(question)}"
    final_output = None
